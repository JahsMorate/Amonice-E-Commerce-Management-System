<%@ Page Title="Amonica | Orderlist" Async="true" Language="C#" MasterPageFile="~/Courier/Courier.Master" AutoEventWireup="true" CodeBehind="Order.aspx.cs" Inherits="Amonica.Courier.Order" %>
                                    ...
                                    <table class="table p-0 m-0 table-responsive table-stripe table-hover table-bordered table-sm" id="example">
                                        ...
                                        <thead>
                                            <tr class="text-white" style="background-color: #686de0;">
                                                ...
                                                <th scope="col" class="text-center  pt-3 pb-3">Contact</th>
                                            ...
                                            <asp:Repeater ID="L_ValidationRegistrations" runat="server">
                                                <ItemTemplate>
                                                    <tr class="p-0">
                                                        ...
                                                        <td class="text-center text-secondary">
                                                            <small>
                                                                <asp:Label ID="Label4" runat="server" CssClass="text-muted" Text='<%# Eval("contact") %>'></asp:Label>
                                                            </small>
                                                        </td>
                                                        <td class="text-center text-secondary">
                                                            <small>
